...
```
The above boxplot shows that the penetrationdata is pretty solid and can be used as is for further analysis. Let's look at the boxplot of the remaining variables.
```{r}
...
```
Most of the cpountries have WiFi hotspots in the range of few hundreds to 5000, whereas Unitedstates has 67718 hotspots followed by France and UK in the 25 thousand range. Another interesting observation is Iceland has only 6. 
